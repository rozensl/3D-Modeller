...
$(PROGRAM_NAME): 3DModeller.o utilities/mathLib3D.o utilities/material.o utilities/colour.o utilities/sceneObject.o utilities/camera.o utilities/PPM.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)

FORCE: ;
graded: FORCE
	$(CC) -o graded graded.cc $(CFLAGS) $(LDFLAGS)
	./graded
